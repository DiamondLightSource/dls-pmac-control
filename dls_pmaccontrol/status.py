...
if the move is done at the velocity specified by Motor[x].MaxSpeed. It is set to 0 if the move is 
        ...
        self.lstTooltips.append(
            """Phase reference established: This bit is set to 0 on power-up/reset for a 
...
the motor, either with a phasing-search move, or an absolute position read. """
        ...
        self.lstTooltips.append(
            """Block request flag set: This bit is set to 1 if the motor has just entered a 
...
Motor[x].PlusInterlock was set. It is 0 otherwise. """
        ...
        self.lstTooltips.append(
            """In position: This bit is set to 1 when all of the conditions for “in position” are 
...
consecutive servo cycles. It is 0 otherwise. """
        ...
        self.lstTooltips.append(
            """Amplifier Enabled: This bit is set to 1 if the motor is enabled (in closed-loop 
...
found, which is before the post-trigger portion of the move is complete. """
        ...
        self.lstTooltips.append("""{Reserved for future use} """)
        self.lstTooltips.append(
            """Auxiliary fault error: This bit is 1 if the motor has been disabled because an 
auxiliary fault error has been detected. It is 0 at all other times, becoming 0 again when the motor 
is re-enabled. """
        )
        self.lstTooltips.append(
            """Encoder loss error: This bit is 1 if the motor has been disabled because an 
encoder loss error has been detected. It is 0 at all other times, becoming 0 again when the motor is 
re-enabled. """
        )
        self.lstTooltips.append(
            """Amplifier warning: This bit is set to 1 if Motor[x].AmpFaultLevel bit 1 
...
is set or not. It is 0 at all other times, changing back to 0 when the next move is started. """
        ...
        self.lstTooltips.append(
            """Integrated current (I2T) fault: This bit is set to 1 when the motor has been 
...
having hit this limit previously. """
        ...
        self.lstTooltips.append(
            """Amplifier fault error: This bit is 1 if the motor has been disabled because of 
an amplifier fault error, even if the amplifier fault signal condition is no longer present, or because of a calculated “I2T” integrated current fault (in which case bit 21 is also set). It is 0 at all other times, becoming 0 again when the motor is re-enabled. """
        ...
        self.lstTooltips.append(
            """Stopped on hardware position limit: This bit is 1 if the motor has stopped 
...
that limit. It is 0 at all other times, including when into a limit, but moving out of it. """
        ...
        self.lstTooltips.append(
            """Fatal following error: This bit is 1 if the motor has been disabled because the 
...
enabled.  """
        ...
        self.lstTooltips.append(
            """Warning following error: This bit is 1 if the magnitude of the following error 
...
to exceeding its fatal following error limit. """
        ...
        self.lstTooltips.append(
            """Hardware positive limit set: This bit is set to 1 when the motor is presently in its positive hardware limit. It is 0 otherwise, even if the motor is still stopped from having hit this limit previously. """
        )
        self.lstTooltips.append(
            """Hardware negative limit set: This bit is set to 1 when the motor is presently in its negative hardware limit. It is 0 otherwise, even if the motor is still stopped from having hit this limit previously. """
        )
        self.lstTooltips.append(
            """Home search move in progress: This bit is set to 1 at the beginning of a homing search move. It is set to 0 when the pre-specified trigger condition is found and the post-trigger move is started, or when the move ends without a trigger being found. """
        )
        self.lstTooltips.append(
            """Trigger search move in progress: This bit is set to 1 at the beginning of a move-until-trigger (homing search, jog-until-trigger, program rapid-mode move-until-trigger). It is set to 0 when the pre-specified trigger condition is found and the post-trigger move is started, or when the move ends without a trigger being found. """
        )
