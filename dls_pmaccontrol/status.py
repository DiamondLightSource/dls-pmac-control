...
class Statusform(QDialog, Ui_formStatus):
    ...
    def __init__(self, parent, axis):
        ...
        self.lstTooltips.append("""In Position: This bit is 1 when five 
...
(I7+1) consecutive scans.""")
        self.lstTooltips.append("""Warning Following Error: This bit is 1 if 
...
limit, or if killed, is re-enabled. """)
        self.lstTooltips.append("""Fatal Following Error: This bit is 1 if 
...
when the motor is reenabled. """)
        self.lstTooltips.append("""Amplifier Fault Error: This bit is 1 if 
...
becoming 0 again when the motor is re-enabled. """)
        self.lstTooltips.append("""Backlash Direction Flag: This bit is 1 if 
        backlash has been activated in the negative direction.
It is 0 otherwise. """)
        self.lstTooltips.append("""I2T Amplifier Fault Error: This bit is 1 
...
becoming 0 again when the motor is re-enabled. """)
        self.lstTooltips.append("""Integrated Fatal Following Error: This bit 
...
re-enabled. """)
        self.lstTooltips.append("""Trigger Move: This bit is set to 1 at the 
...
move was successful in finding the trigger. """)
        self.lstTooltips.append("""Phasing Reference Error: This bit is set 
...
successful phasing search). """)
        self.lstTooltips.append("""Phasing Search/Read Active: This bit is 
...
position read is currently ongoing for the motor. It is set to 0 otherwise. """)
        self.lstTooltips.append("""Home Complete: This bit, set to 0 on 
...
Position bit to monitor for the end of motor motion. """)
        self.lstTooltips.append("""Stopped on Position Limit: This bit is 1 
...
it. """)
        ...
        self.lstTooltips.append("""Stopped on Desired Position Limit: This 
...
function). It is 0 otherwise. """)
        self.lstTooltips.append("""Foreground In-Position: This bit is 1 when 
...
otherwise. """)
        ...
        self.lstTooltips.append("""Assigned to C.S.: This bit is 1 when the 
...
coordinate system. """)
        ...
        self.lstTooltips.append("""Coordinate Definition: These four bits 
...
7: Assigned to XYZ axes """)
        ...
        self.lstTooltips.append("""(C.S. - 1) Number: These three bits 
...
22 =1, bit 21 = 0, and bit 20 = 1. """)
        ...
        self.lstTooltips.append("""Maximum Rapid Speed: This bit is 1 when 
...
jog speed parameter for RAPID moves. """)
        self.lstTooltips.append("""Alternate Command-Output Mode: This bit is 
...
are output in the standard mode. """)
        self.lstTooltips.append("""Software Position Capture: This bit is 1 
...
for the post-trigger move. """)
        self.lstTooltips.append("""Error Trigger: This bit is 1 when Ixx97 
...
triggered moves trigger on a specified input flag state. """)
        ...
        self.lstTooltips.append("""Following Enabled: This bit is 1 when 
...
Sixth character returned: """)
        self.lstTooltips.append("""Following Offset Mode: This bit is 1 when 
...
programming reference does not move with the following. """)
        self.lstTooltips.append("""Phased Motor: This bit is 1 when Ixx01 bit 
...
Turbo PMAC. """)
        self.lstTooltips.append("""Alternate Source/Destination: This bit is 
...
motor. """)
        ...
        self.lstTooltips.append("""User-Written Servo Enable: This bit is 1 
...
and the motor executes the normal servo routine. """)
        self.lstTooltips.append("""User-Written Phase Enable: This bit is 1 
...
and the motor executes the normal phase routine. """)
        self.lstTooltips.append("""Home Search in Progress: This bit is set 
...
instead. """)
        self.lstTooltips.append("""Block Request: This bit is 1 when the 
...
use. """)
        ...
        self.lstTooltips.append("""Abort Deceleration: This bit is 1 if the 
...
to 0 when the commanded deceleration to zero velocity finishes. """)
        self.lstTooltips.append("""Desired Velocity Zero: This bit is 1 if 
...
mode with non-zero commanded velocity, or if it is in open-loop mode. """)
        self.lstTooltips.append("""Data Block Error: This bit is 1 when move 
...
Run Time Error Coordinate System status bit. """)
        self.lstTooltips.append("""Dwell in Progress: This bit is 1 when the 
        motor’s coordinate system is executing a DWELL
instruction. It is 0 otherwise. """)
        self.lstTooltips.append("""Integration Mode: This bit is 1 when Ix34 
...
integrator is always active. """)
        self.lstTooltips.append("""Running Definite-Time Move: This bit is 1 
...
commanded move
finishes. """)
        self.lstTooltips.append("""Open Loop Mode: This bit is 1 when the 
...
is not updated. """)
        self.lstTooltips.append("""Negative End Limit Set: This bit is 1 when 
...
this bit is not updated. """)
        self.lstTooltips.append("""Motor Activated: This bit is 1 when Ix00 
